...
class DarwinConnection extends AbstractConnection implements ConnectionInterface
{
    ...
    {
        // For Darwin, $rate is the literal baud rate to assign - no conversion
    ...
    {
        // Define the Darwin stty flags for various parity values
        $arguments = array(
    ...
    {
        // Define the Darwin stty flags for various flow control types
        $arguments = array(
